...
export default function Home() {
  return (
    <div>
      ...
      <div className="container-md text-break pt-10 d-flex align-items-center content-center flex-md-row flex-column w-auto space-y-5">
              <Image className='rounded mx-auto d-block h-2/4 w-2/4' src={image} alt="background" />
