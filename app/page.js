  ...
  return (
    <div>
      ...
      <div className="container-md text-break pt-md-4 px-md-5 d-flex align-items-center content-center flex-lg-row flex-column w-auto mt-5 fading-effect">
              <Image className='rounded shadow mx-auto d-block img-fluid mb-4' src={image} alt="background" width={500}/>
              ...
              <a className="btn btn-primary mt-4 text-center fw-bold" href="./skills">Know More</a>
              </div>
            </div>
    </div>
  );
