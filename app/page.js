  ...
  return (
    <div>
      ...
      <div className="container-md text-break pt-md-4 px-md-5 d-flex align-items-center content-center flex-lg-row flex-column w-auto mt-5 fading-effect">
              <Image className='rounded shadow mx-auto d-block img-fluid mb-4' src="https://avatars.githubusercontent.com/u/30649674?v=4" alt="background" width={500} placeholder="blur"/>
