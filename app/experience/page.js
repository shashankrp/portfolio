...
function page(props) {
    return (
        <div className='container-md w-auto text-wrap font-monospace border-radius-md my-container experience-container'>
            ...
            <ul className='w-auto pr-4'>
                ...
                <ul className='list-group-numbered'>
                    ...
                    <li className="list-group-item text-justify">&nbsp;Issue Resolution: Analyze the results of API testing to identify the root causes of the
                        ...
                        future reference.</li>
                    <li className="list-group-item text-justify">&nbsp;Working with our R & D team on Development, Unit testing and preparing user guide pipelines and UI using AI for the partners.</li>
                </ul>
            </ul>
